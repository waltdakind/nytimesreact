...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchQuery = __webpack_require__(232);
	var SearchResults = __webpack_require__(233);
	...
	var Search = React.createClass({
	    ...
	    handleQuerySubmit: function handleQuerySubmit(queryTermValue, startYearValue, endYearValue) {

	        console.log('QUERY: ' + queryTermValue + ' ' + startYearValue + ' ' + endYearValue);

	        /*PASS VALUES TO HELPER FUNCTION*/
	        helper.getSearchResults(queryTermValue, startYearValue, endYearValue).then(function (data) {
	            this.setState({
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(SearchQuery, { submitQuery: this.handleQuerySubmit })
	                    )
	                ),
	                React.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchQuery = React.createClass({
	    ...
	    handleNewQuerySubmit: function handleNewQuerySubmit(e) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control ', ref: 'queryTermInput' }),
	                React.createElement(
	                    'h4',
	                    { className: '' },
	                    React.createElement(
	                ...
	                React.createElement('input', { type: 'number', className: 'form-control ', ref: 'startYearInput' }),
	                React.createElement(
	                    'h4',
	                    { className: '' },
	                    React.createElement(
	                ...
	                React.createElement('input', { type: 'number', className: 'form-control ', ref: 'endYearInput' })
	            ),
	            React.createElement(
	                'div',
	...
	var SearchResults = React.createClass({
	    ...
	    render: function render() {
	        ...
	        function item(result) {
	            ...
	            return React.createElement(
	                'li',
	                { className: 'list-group-item', key: result._id },
	                React.createElement(
	                    'div',
	                    { className: 'btn-group pull-right' },
	                    React.createElement(
	                        'a',
	                        { className: 'btn btn-default', href: result.web_url, target: '_blank' },
	                        'View Article'
	                    ),
	                    React.createElement(
	                        'a',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helper = {
	    getSearchResults: function getSearchResults(topic, yearStart, yearEnd) {
